...
then
    ...
    alias cleos="docker-compose -f $EOS_ENV_DIR/eos-compile-service/docker/docker-compose-dawn3.0.yaml exec keosd /opt/eosio/bin/cleos -u http://docker_nodeosd_1"
